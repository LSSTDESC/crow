...
from crow import ClusterShearProfile, completeness, kernel, mass_proxy, purity
...
def build_likelihood(
    ...
    mass_distribution = mass_proxy.MurataBinned(
        pivot_mass, pivot_redshift, purity=purity.PurityAguena16()
    )
    ...
    recipe = MurataBinnedSpecZRecipe(
        ...
        completeness=completeness.CompletenessAguena16(),
        mass_interval=(12, 17),
